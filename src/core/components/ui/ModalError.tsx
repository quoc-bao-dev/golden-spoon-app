...
const ModalError: React.FC<ModalErrorProps> = ({
    ...
    message = "Liên kết bạn dùng đã hết hạn hoặc không còn tồn tại. Nếu bạn cần hỗ trợ, hãy liên hệ với chúng tôi nhé.",
    rateButtonText = "Liên hệ Admin",
    skipButtonText = "Thoát",
}) => {
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="flex flex-col items-center space-y-6">
                ...
                <div className=" flex items-center justify-center">
                    <Icon icon="icon-error" size={55} className="text-white" />
                </div>
